    ...
    <nav class="navbar navbar-default" id="nav">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
	                <li class="active"><a href="<%=request.getContextPath() %>/index.main" style="margin-right: 10px;">메인</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
            	...
            	<c:choose>
	                ...
	                <c:otherwise>
		                <li><a href="<%=request.getContextPath() %>/user/mypage.user">My Page</a></li>
